  ...
  <div class="w-full select-none">
    ...
    <form action="/login" method="post" @submit.prevent="submit">
      ...
      <div class="flex justify-end mt-8">
        <button id="login-cancel-button" class="btn-link mr-8" @click="modals.jesseTradeLogin = false">Cancel</button>
        <button id="login-submit-button" class="btn-primary w-32" type="submit">Login</button>
      </div>
    </form>
  </div>
</template>
