  ...
  <div class="mb-4">
    ...
    <div class="hidden sm:block">
      <nav class="relative z-0 rounded-lg shadow flex divide-x divide-gray-200 " aria-label="Tabs">
        ...
        >
          <router-link
            :class="[tab.id === pageId ? 'text-gray-900 dark:text-gray-100 font-bold' : 'text-gray-500 dark:text-gray-300 hover:text-gray-700 bg-white dark:bg-gray-600', 'py-4 px-4 inline-block select-none cursor-pointer focus:outline-none bg-white dark:bg-gray-700 w-full text-sm font-medium hover:bg-gray-50 dark:hover:bg-gray-700 focus:z-10']"
            :to="`${tab.id}`">
        ...
        <!-- New Tab Button-->
        <div class="select-none cursor-pointer text-gray-400 dark:text-gray-100 hover:text-gray-600 focus:outline-none group relative w-14 overflow-hidden bg-white dark:bg-gray-600 py-4 px-4 font-medium hover:bg-gray-50 dark:hover:bg-gray-700 focus:z-10 flex items-center justify-center"
             @click="addTab">
